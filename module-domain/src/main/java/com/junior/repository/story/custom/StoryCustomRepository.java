...
public interface StoryCustomRepository {
    ...
    public List<ResponseStoryDto> findStoryByMap(Member findMember, GeoPointDto geoPointLt, GeoPointDto geoPointRb);

    public Slice<ResponseStoryDto> findStoriesByMemberAndCityAndSearch(Long cursorId, Pageable pageable, Member findMember, String city, String search);
